...
reliably good, not just lucky on one. <a href="index.html">← leaderboard</a> ·
...
<footer class="wrap">Generated by <code>scripts/robustness.py</code> from per-seed snapshots.</footer>
    ...
    (DIR / "robustness.html").write_text(html, encoding="utf-8")
    ...
    print(f"Wrote {DIR/'robustness.html'}")
